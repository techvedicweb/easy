 ...
 echo "../docs/".$_SESSION['userid']."/Agent/".$pic;
  ...
  var loadFile = function(event) {
    ...
    output.src = URL.createObjectURL(event.target.files[0]);
            ...
            <div class="col-sm-5">
              <div>
                <input type="hidden" name="id" value="<?php echo $agent_val['id'];?>" >
<!-- for image old name send -->

 <input type="hidden" name="old_image" value="<?php echo $agent_val['agent_pic'];?>">

<!-- end here old name script -->


                <input type="radio" name="agent_type" value="Full Time"

                    <?php
if($agent_val['agent_type']=="Full Time"){
echo "checked";
}
                ?>
                >
            ...
            <div class="col-sm-5">
              <div>
                <input type="radio" name="agent_type" value="Occasional" 
                    ...
                    <?php
if($agent_val['agent_type']=="Occasional"){
echo "checked";
}
                ?>
          ...
          <h4 class="h4 padding-top-10 weight-600">Agent information</h4>
              ...
              <input type="text" name="agent_name" id="agent_name" value="<?php echo $agent_val['name'];?>" class="form-control" required>
            </p>
            <p class="margin-top-10">
              <label>Email</label>
              <input type="emai" name="email" id="email" value="<?php echo $agent_val['email'];?>" class="form-control">
            </p>
            <p class="margin-top-10">
              <label>Title</label>
              <input type="text" name="title" id="title" value="<?php echo $agent_val['title'];?>" class="form-control">
            </p>
            <p class="margin-top-10">
              <label>Phone No.</label>
              <input type="text" name="phone_number" id="phone" value="<?php echo $agent_val['phone_no'];?>" class="form-control">
            </p>
            <p class="margin-top-10">
              <label>Mobile No.</label>
              <input type="text" name="mobile_number" id="mob" value="<?php echo $agent_val['mobile_number'];?>" class="form-control">
            </p>
            <p class="margin-top-10">
...
if($agent_val['location_id']==$view_loc_object['id']){
echo "selected";
}
...
?>
            ...
            <p class="margin-top-10">
              ...
              <input type="text" name="reporting_manager" value="<?php echo $agent_val['reporting_manager_id'];?>" class="form-control">
            </p>
            <div class="margin-top-10 border-bottom padding-bottom-30">
              ...
              <textarea name="signature" id="descr"  style="width:100%; border:#ccc solid 1px; height: 130px;">
              <?php echo $agent_val['signature'];?></textarea>
              <!--end-->
            </div>
            ...
            <div class="row margin-top-20">
              ...
              <div class="col-sm-7 col-md-8 col-xs-12">
                <input type="radio" name="ticket_scope" id="global" value="Group Access"
                <?php
if($agent_val['ticket_scope']=="Group Access"){
echo "checked";
}
                ?>
    ...
    <?php
if($agent_val['ticket_scope']=="Global Access"){
echo "checked";
}
                ?>
                >
    ...
    <?php
if($agent_val['ticket_scope']=="Restricted Access"){
echo "checked";
}
                ?>
                >
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <tbody>
                          <tr>
                            <td>
<?php 
$ass_role=$agent_val['associate_role'];
$ex=explode(',',$ass_role);
...
echo "checked";
                ...
                <div class="p-xs text-gray padding-bottom-10">Can view all Tickets in the Helpdesk</div>
                            ...
                            <tr>
              <td>
                  <input type="checkbox" id="sd" name="associate_role[]" value="Hardware" 
    <?php
    foreach ($ex as  $value){
if($value=="Hardware"){
echo "checked";
...
if(result=="Agent Updated Successfully"){
  alert(result);
