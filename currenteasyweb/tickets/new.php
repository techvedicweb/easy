              ...
              <div class="x_title">
                <div class="row">
				  ...
				  <div class="col-lg-7 padding-top-10">
						  <a href="<?php echo WEB_ROOT;?>tickets/index.php" class="h4"><i class="icon-left-small"></i>Back to Changes</a>
						</div>
						<div class="col-lg-5 text-right MrTpMd-10">
						 <a href="<?php echo WEB_ROOT;?>tickets/index.php" class="btn btn-danger btn-round">Cancel</a>
						 <div class="btn-group">
