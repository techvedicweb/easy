      ...
      <div class="row checkList">
        <div class="col-md-9 col-sm-12 col-xs-12 margin-top-10">
          <div class="x_panel tile">
            <div class="x_title">
              <div class="row">
                <div class="col-lg-7 padding-top-10"> <a href="<?php echo WEB_ROOT;?>contracts/index.php" class="h4"><i class="icon-left-small"></i>Back to Contracts</a> </div>
                <div class="col-lg-5 text-right MrTpMd-10"> <a href="<?php echo WEB_ROOT;?>contracts/index.php" class="btn btn-danger btn-round">Cancel</a>
                  <div class="btn-group">
