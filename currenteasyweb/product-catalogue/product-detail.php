...
<span onclick="product_delete_form(this.id);" id="<?php echo $product_val["id"];?>"  style="cursor:pointer;" class="btn btn-round btn-default">Delete</span>
          ...
          <!-- Vendors ::: Start -->
            <div class="row margin-top-10 margin-bottom-5" style="margin-left: 0; margin-right: 0">
              ...
              <p class="excerpt"> No Vendors associated  <a href="#" class="btn btn-success btn-xs" id="add_vendors">Add Vendor</a></p>
                    ...
                    <div class="">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          <button type="button" class="close" id="close-vendor"><span aria-hidden="true">×</span>
                          </button>
          ...
          <!-- Associates Assets -->
            ...
            <p><a href="#" class="btn btn-success btn-xs" id="add_assets"></i> Add Asset</a></p>

            <div class="add_assets" style="display: none">
                    <div >
                      <div class="modal-content">

                        <div class="modal-header">
                          <button type="button" class="close" id="close-box"><span aria-hidden="true">×</span>
                          </button>
...
<script>
      $('#add_vendors, #close-vendor').click(function(){
        $('.add_vendors').toggle();
      });
      $('#add_assets, #close-box').click(function(){
        $('.add_assets').toggle();
      });
    </script>>
</body>
